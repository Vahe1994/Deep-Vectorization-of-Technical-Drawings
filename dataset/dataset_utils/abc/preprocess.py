...
def preprocess_beziers_only():
    ...
    for subset in 'val', 'train':
        data_root = f'/data/abc_everything/testing_patches/{subset}'#f'/data/svg_datasets/patched/abc/everything/{subset}'
        out_root = f'/data/preprocessed/everything_is_quad_bezier/{subset}'
